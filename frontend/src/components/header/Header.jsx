...
const Header = () => {
  ...
  return (
    <header className="header">
      ...
      <CustomNavbar toggle={toggle} setToggle={setToggle} />
      <HeaderRight />
./redux/apiCalls/authApiCal    </header>
  );
};
        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              ...
              <NavDropdown title={t('posts')} id="posts-dropdown">
              ...
              {!user ? (
                ...
                <Nav.Link onClick={logoutUser}>{t('logout')}</Nav.Link>
              )}
